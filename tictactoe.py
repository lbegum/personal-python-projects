...
def isWinner(bo, le):
    ...
    # bo and le is used instead of board and 
    # letter respectively to minimise typing errors
...
def getPlayerMove(board):
    ...
    while move not in '1 2 3 4 5 6 7 8 9'.split() or not \
        ...
        print('What is your next move? (1-9). 1 being bottom left, ' +
        'and 9 being top right')
        move = input()
    return int(move)
